...
ros::Publisher pub_initial_status;
...
void registerPub(ros::NodeHandle &n)
{
    ...
    pub_initial_status = n.advertise<std_msgs::Bool>("initial_status",10);
...
void pubInitialStatus(const Estimator &estimator)
{
    std_msgs::Bool status;
    status.data = estimator.initialized;
    pub_initial_status.publish(status);
}
